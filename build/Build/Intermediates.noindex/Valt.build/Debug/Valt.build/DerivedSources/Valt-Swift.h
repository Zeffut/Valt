...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Valt",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC4Valt11AppDelegate")
...
SWIFT_CLASS_NAMED("ClipItem")
@interface ClipItem : NSManagedObject
@property (nonatomic, copy) NSUUID * _Nonnull id;
@property (nonatomic, copy) NSData * _Nonnull content;
@property (nonatomic, copy) NSString * _Nonnull type;
@property (nonatomic, copy) NSString * _Nullable plainText;
@property (nonatomic, copy) NSString * _Nullable sourceApp;
@property (nonatomic, copy) NSString * _Nullable sourceAppName;
@property (nonatomic, copy) NSDate * _Nonnull createdAt;
@property (nonatomic, strong) Pinboard * _Nullable pinboard;
- (nonnull instancetype)initWithEntity:(NSEntityDescription * _Nonnull)entity insertIntoManagedObjectContext:(NSManagedObjectContext * _Nullable)context OBJC_DESIGNATED_INITIALIZER;
@end

SWIFT_CLASS("_TtC4Valt10PastePanel")
...
@class NSSet;
SWIFT_CLASS_NAMED("Pinboard")
@interface Pinboard : NSManagedObject
@property (nonatomic, copy) NSUUID * _Nonnull id;
